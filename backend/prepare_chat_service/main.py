...
def prepare_chat_session(request):
    ...
    try:
        ...
        # Step 2: Robustly parse the incoming JSON payload.
        ...
        # Step 3: Enforce ownership. The authenticated user must match the file's owner.
        if file_data.get('userId') != user_uid:
            return ("Permission denied: User does not own this file.", 403)

        # Step 4: Proceed with the function's core logic.
