...
import '../../../document_preview/presentation/pages/document_preview_page.dart';
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => DocumentPreviewPage(
              imagePath: imagePath,
              onDocumentProcessed: (processedPath) {
                // Handle the processed document
                Navigator.of(context).pop(); // Go back to camera
                Navigator.of(context).pop(); // Go back to home
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Document processed: $processedPath')),
                );
              },
            ),
          ),
