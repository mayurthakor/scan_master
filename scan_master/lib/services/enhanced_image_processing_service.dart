...
// Extended OptimizationSettings with new parameters
extension OptimizationSettingsExtended on OptimizationSettings {
  static OptimizationSettings create({
    required bool enhanceContrast,
    required bool sharpenText,
    required bool adjustBrightness,
    required bool removeBackground,
    required bool preserveColors,
    required bool ocrOptimization,
    required double compressionLevel,
    bool autoRotate = true,
    bool reduceNoise = true,
    bool finalSharpen = true,
    double backgroundThreshold = 0.12,
    double noiseReductionStrength = 0.3,
    double sharpenStrength = 0.7,
  }) {
    return OptimizationSettings(
      ...
      ocrOptimization: ocrOptimization,
      compressionLevel: compressionLevel,
    );
  }

  static OptimizationSettings defaultSettings() {
    return OptimizationSettings(
      enhanceContrast: true,
      sharpenText: true,
      adjustBrightness: true,
  ...
  // Getters for new properties (with defaults)
  bool get autoRotate => true;
  bool get reduceNoise => true;
  bool get finalSharpen => true;
  double get backgroundThreshold => 0.12;
  double get noiseReductionStrength => 0.3;
  double get sharpenStrength => 0.7;
}